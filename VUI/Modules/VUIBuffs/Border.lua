VUIBuffsBorderTemplateMixin = {};

function VUIBuffsBorderTemplateMixin:SetVertexColor(r, g, b, a)
    for _, texture in ipairs(self.Textures) do
        texture:SetVertexColor(r, g, b, a);
    end
end

function VUIBuffsBorderTemplateMixin:SetBorderSizes(borderSize, borderSizeMinPixels, upwardExtendHeightPixels, upwardExtendHeightMinPixels)
...
function VUIBuffsBorderTemplateMixin:UpdateSizes()
