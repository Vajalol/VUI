...
function Module:OnEnable()
    local db = VUI.db.profile.chat.copy
    if (db) then
        ...
        local function CreateCopyButton(self)
            ...
            self.Copy:SetNormalTexture("Interface\\AddOns\\VUI\\Media\\Textures\\Chat\\copynormal")
            self.Copy:GetNormalTexture():SetSize(20, 20)

            self.Copy:SetHighlightTexture("Interface\\AddOns\\VUI\\Media\\Textures\\Chat\\copyhighlight")
