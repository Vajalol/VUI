local Module = VUI:NewModule("General.AfkCam");

function Module:OnEnable()
    local db = VUI.db.profile.general.cosmetic.afkscreen
    if (db) then
        ...
        local blank = [[Interface\AddOns\VUI\textures\blank.tga]]
        local normTex = [[Interface\AddOns\VUI\textures\normTex.tga]]
