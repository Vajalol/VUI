...
function Buffs:OnEnable()
    ...
    function ButtonDefault(button)
        ...
        border.texture:SetTexture("Interface\\Addons\\VUI\\Media\\Textures\\Core\\UIActionBar")
    ...
    function ButtonBackdrop(button)
        ...
        border.texture = border:CreateTexture(nil, "Border")
        border.texture:SetTexture("Interface\\Addons\\VUI\\Media\\Textures\\Core\\Normal_N")
        border.texture:SetVertexColor(0, 0, 0)
