local Module = VUI:NewModule("ActionBars.Mouseover");
...
function Module:OnEnable()
    ...
    local db = {
        bars = VUI.db.profile.actionbar.bars,
        micromenu = VUI.db.profile.actionbar.menu.micromenu,
        bagbar = VUI.db.profile.actionbar.menu.bagbar,
