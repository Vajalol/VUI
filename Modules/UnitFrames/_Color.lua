local Module = VUI:NewModule("UnitFrames.Colors")
...
function Module:OnEnable()
    ...
    local db = VUI.db.profile.unitframes
    local texture = VUI.db.profile.general.texture
    if (db) then
        if (db.classcolor) then
            function VUIUnitColor(healthbar, unit)
