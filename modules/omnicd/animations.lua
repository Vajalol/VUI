...
function OmniCD:ApplyPhoenixFlameTheme(frame)
    ...
    glow:SetTexture(MediaPath.."textures\\"..themeDir.."\\animation\\flame1.tga")
...
function OmniCD:ApplyThunderStormTheme(frame)
    ...
    lightning:SetTexture(MediaPath.."textures\\"..themeDir.."\\castbar\\lightning.svg")
    ...
    local surgeEffect = function(frame)
        ...
        surge:SetTexture(MediaPath.."textures\\"..themeDir.."\\castbar\\surge.svg")
...
function OmniCD:ApplyArcaneMysticTheme(frame)
    ...
    rune:SetTexture(MediaPath.."textures\\"..themeDir.."\\castbar\\rune.svg")
...
function OmniCD:ApplyFelEnergyTheme(frame)
    ...
    glow:SetTexture(MediaPath.."textures\\"..themeDir.."\\castbar\\glow.svg")
    glow:SetBlendMode("ADD")
