...
VUIConfig.ScrollFrameEvents = {
        ...
        OnScrollRangeChanged = function(self, _, yRange)
                ...
                scrollUpButton:Hide();
                --scrollUpButton:SetTexture([[Interface\AddOns\VUI\Libs\VUIConfig\Media\ScrollUp]])
...
VUIConfig.ScrollFrameMethods = {
        ...
        UpdateSize     = function(self, newWidth, newHeight)
                ...
                self.VUIConfig:GlueAcross(self.scrollFrame, self, 2, -2, -self.scrollBarWidth - 2, 2);
...
function VUIConfig:ScrollFrame(parent, width, height, scrollChild)
...
VUIConfig.FauxScrollFrameMethods = {
...
VUIConfig.FauxScrollFrameEvents = {
...
--- of items
function VUIConfig:FauxScrollFrame(parent, width, height, displayCount, lineHeight, scrollChild)
...
--- HybridScrollFrame
----------------------------------------------------
VUIConfig.HybridScrollFrameMethods = {
        ...
        CreateItems         = function(self, data, create, update, padding, oX, oY)
                ...
                self.VUIConfig:ObjectList(scrollChild, self.items, create, update, data, padding, oX, oY,
...
function VUIConfig:HybridScrollFrame(parent, width, height, scrollChild)
        local panel = self:ScrollFrame(parent, width, height, scrollChild);
