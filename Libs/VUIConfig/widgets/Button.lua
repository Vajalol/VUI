...
local SquareButtonMethods = {
	SetIconDisabled = function(self, texture, iconWidth, iconHeight)
		self.iconDisabled = self.VUIConfig:Texture(self, iconWidth, iconHeight, texture);
	...
	SetIcon = function(self, texture, iconWidth, iconHeight, alsoDisabled)
		self.icon = self.VUIConfig:Texture(self, iconWidth, iconHeight, texture);
...
function VUIConfig:SquareButton(parent, width, height, icon)
...
function VUIConfig:ButtonLabel(parent, text)
...
function VUIConfig:HighlightButtonTexture(button)
...
--- @return Button
function VUIConfig:HighlightButton(parent, width, height, text, inherit)
...
--- @return Button
function VUIConfig:Button(parent, width, height, text, inherit)
...
function VUIConfig:ButtonAutoWidth(button, padding)
