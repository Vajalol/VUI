...
--- @return Frame
function VUIConfig:Window(parent, width, height, title)
	...
	function frame:MakeResizable(direction)
		VUIConfig:MakeResizable(frame, direction);
		return frame;
	end
...
VUIConfig.dialogs = {};
--- @return Frame
function VUIConfig:Dialog(title, message, dialogId)
	local window;
...
--- }
--- @return Frame
function VUIConfig:Confirm(title, message, buttons, dialogId)
