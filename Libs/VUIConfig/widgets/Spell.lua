...
function VUIConfig:SpellBox(parent, width, height, iconSize, spellValidator)
...
function VUIConfig:SpellInfo(parent, width, height, iconSize)
	iconSize = iconSize or 16;
	...
	VUIConfig:GlueRight(btn, frame, -3, 0, true);
...
function VUIConfig:SpellCheckbox(parent, width, height, iconSize)
	iconSize = iconSize or 16;
